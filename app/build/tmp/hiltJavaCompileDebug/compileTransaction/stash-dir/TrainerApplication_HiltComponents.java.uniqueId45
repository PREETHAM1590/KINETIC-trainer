...
import com.kinetic.trainer.di.AppModule;
...
public final class TrainerApplication_HiltComponents {
  private TrainerApplication_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements TrainerApplication_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          WorkoutAssignmentViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          WorkoutAssignmentViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
